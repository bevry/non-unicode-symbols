...
``` typescript
import * as pkg from 'https://unpkg.com/non-unicode-symbols@^7.2.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/non-unicode-symbols@^7.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/non-unicode-symbols@^7.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/non-unicode-symbols@7.2.0'
</script>
```
